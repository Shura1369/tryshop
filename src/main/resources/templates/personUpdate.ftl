...
<tr>
                ...
                <form name="person" action="" method="POST">
                    ...
                    <td> <a href="/passport/update/${personForm.passportId}" type="button" class="btn btn-success">UpdatePassport</a>
                    <br> Address      :<@spring.formInput  "personForm.address" 'class ="form-control" readonly' "text" />
                    <td>  <a href="/address/update/${personForm.addressId}" type="button" class="btn btn-success">UpdateAddress</a>
